...
class SymbolCopyApp(wx.Frame):
    ...
    def InitUI(self):
        ...
        instructions = wx.StaticText(panel, label="Click a symbol to copy it to clipboard")
    ...
    def OnCopyToClipboard(self, event):
        ...
        wx.MessageBox(f"Copied '{symbol}' to clipboard!", "Copied", wx.OK | wx.ICON_INFORMATION)
