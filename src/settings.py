...
class SettingsApp(wx.Frame):
    ...
    def initUI(self):
        ...
        if wx.Platform == "__WXMSW__":
            ...
            self.header_active_btn = wx.Button(
                panel, label="Choose Color", size=(100, -1)
            )
            ...
            self.header_inactive_btn = wx.Button(
                panel, label="Choose Color", size=(100, -1)
            )
    ...
    def on_save(self, event):
        ...
        wx.MessageBox(
            "Settings saved successfully", "Info", wx.OK | wx.ICON_INFORMATION
        )
